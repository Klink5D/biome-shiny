...
#### Introduction
Biome-shiny is a tool designed to provide an easy-to-use interface for visualizing and analyzing microbiomes. The application was created with users with little programing experience in mind, to facilitate interacting with functions from libraries such as Phyloseq and Microbiome. The plots are generated with the Plotly library, allowing the user to interact with results more easily. Finally, Biome-shiny is capable of exporting results in an HTML file.

The current version is capable of the following functions:
* Core microbiota visualization and dataset filtering;
* Community composition visualization;
* Alpha diversity analysis and visualization;
* Beta diversity analysis and visualization;
* Exporting results in an HTML file.
